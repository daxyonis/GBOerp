...
public class GBOlogger {		
	...
	public static final String LOG_EMAIL = "e.maciejko@groupeboconcept.com";
	
	@Autowired
	public void setErrorInfoDAO(ErrorInfoDAOImpl errInfoDAOImpl) {
		this.errInfoDAO = errInfoDAOImpl;
	}
	...
	public static void LogError(String callingMethod, Throwable e, Context ctx) {
		...
		err.setAppVersion(Play.application().configuration().getString("app.version"));
		err.setUsager(user);		
