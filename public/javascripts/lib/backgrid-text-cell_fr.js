  ...
  */
  var TextareaEditor = Backgrid.Extension.TextareaEditor = Backgrid.CellEditor.extend({
    ...
    template: function (data) {
      return '<div class="modal-dialog"><div class="modal-content"><form><div class="modal-header"><button type="button" class="close" data-dismiss="modal">&times;</button><h3>' + data.column.get("label")  + '</h3></div><div class="modal-body"><textarea cols="' + data.cols + '" rows="' + data.rows + '">' + data.content + '</textarea></div><div class="modal-footer"><input class="btn btn-primary" type="submit" value="OK"/></div></form></div></div>';
    },
        ...
        if (e) {
          ...
          e.stopPropagation();
               ...
               (e.type == "hide" &&
                ...
                confirm("Voulez-vous conserver les changements?"))) {
    ...
    */
    focus: function () {
	  ...
	  //this.$('.modal-content').css("width","650px");
    }
